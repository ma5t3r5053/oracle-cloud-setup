...
echo -e "\e[1;32m => provision \"$instance_name\" instance \e[0m"


#============================================================================================================================
#cp ~/ol-sample-scripts/oci-provision/oci-provision.env.distr ~/ol-sample-scripts/oci-provision/oci-provision.env
  ...
  while [[ $# -gt 0 ]]; do
    case "$1" in
      ...
      "--subnet")
        ...
        ;;
	  "--compartment-id")
        [[ $# -lt 2 ]] && missing_parameter "compartment-id"
        compartment_id="$2"
        shift; shift
        ;;
      *)
